module github.com/tmm-tanzu/tanzu-java-web-app/hack/kctrl

go 1.24.4

require carvel.dev/kapp-controller/cli v0.0.0-20250527071352-b221a850ba1c

require (
	carvel.dev/kapp-controller v0.57.0 // indirect
